...
var map, 
infowindow,
foursquareID="Q55FKP4Q4UOLIPVR0ITORHNILDCQDGWLCFM0MA1ZNVTCPAH4",
foursquareKey="CDZRIXAWM1KR3GTHHEUL1REEL14FQOIIK4BENU13N0GOPVNK";
...
//function that will fire up if google map can't be loaded.
function errorShow(){
...
//variable and function used to handle click event on the list(using KO click binding)
  ...
  self.setCurrentPlace=function(place){
    ...
    self.currentPlace.marker.setAnimation(google.maps.Animation.DROP);
